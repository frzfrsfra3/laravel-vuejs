...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
 ...
 <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-left navbar-search-block float-left" >
          {{-- <form class="form-inline"> --}}
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" @keyup="searchit" v-model="search" placeholder="Search" aria-label="Search">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item has-treeview menu-open"> --}}
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link to="/shopify" class="nav-link">
                  <i class="far fas fa-circle nav-icon"></i>
                  <p>Inactive Page</p>
                </router-link>
              </li>
